...
public class AccesscodemanagementRestServiceImpl implements AccesscodemanagementRestService {
  ...
  public EstimatedTime getEstimatedTime(AccessCodeEto accessCodeEto) {
    ...
    return this.accesscodemanagement.getEstimatedTime(accessCodeEto);
  }

  @Override
  public RemainingCodes getRemainingCodes(AccessCodeEto accessCodeEto) {

    return this.accesscodemanagement.findRemainingCodes(accessCodeEto);
  }
}