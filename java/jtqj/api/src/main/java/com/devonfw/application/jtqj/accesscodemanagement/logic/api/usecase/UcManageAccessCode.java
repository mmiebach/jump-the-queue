...
public interface UcManageAccessCode {
  ...
  /**
   * Deletes a accessCode from the database by its id 'accessCodeId'. Decreases the count of customers of the queue
  ...
  /**
   * Saves a queue and store it in the database. Increases the count of customers of the queue assigned to the access
   * code by one
   *
   ...
   * @return
   */
  EstimatedTime getEstimatedTime(AccessCodeEto accessCodeEto);
